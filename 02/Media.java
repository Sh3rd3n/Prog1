...
public class Media {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(int)media3 = " + (int) media3);    // per difetto = 2
        System.out.println("(int)Math.round(media3) = " + (int) Math.round(media3));    // per eccesso (> .5) = 3
