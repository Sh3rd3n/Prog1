...
public class MassimoDueVariabili {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Inserisci un numero x: ");
        x = SIn.readLineInt(); // non so se sia giusta la riga sopra e quindi fare s.
        System.out.println("Inserisci un numero y: ");
        y = SIn.readLineInt();
        ...
        else System.out.println("max =" + x2);
